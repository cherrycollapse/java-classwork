...
import step.learning.services.homework.DateTimeService;
...
//    private HashService hash160 ;
    ...
    @Inject
    public App(@Named("ten") RandomProvider randomProvider, @Named("128") HashService hash128, @Named("160") HashService hash160, StringService stringService) {
        this.randomProvider = randomProvider;
...
//    Ін'єктувати службу у App, вивести рез-ти роботи методів.
    ...
    public void run() {
        ...
        System.out.println("Date : " + dateTimeService.getDate());
        System.out.println("Time : " + dateTimeService.getTime());
